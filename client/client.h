...
class FlowClient {
    public:
        ...
        std::unique_ptr<flow::access::SendTransactionResponse> SendTransaction(::grpc::ClientContext* context, flow::access::Transaction* transaction);
        ...
        std::unique_ptr<flow::access::ExecuteScriptResponse> ExecuteScriptAtLatestBlock(::grpc::ClientContext* context, const char* script);
        std::unique_ptr<flow::access::ExecuteScriptResponse> ExecuteScriptAtBlockID(::grpc::ClientContext* context, const char* script, const std::string& id);
        std::unique_ptr<flow::access::ExecuteScriptResponse> ExecuteScriptAtBlockHeight(::grpc::ClientContext* context, const char* script, uint64_t height);
